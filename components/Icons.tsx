...
// Map Icon
export function MaterialSymbolsLocationOnOutline(
...
// clock icon
export function IcSharpAccessTime(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
// Chevron Up
export function Fa7SolidChevronUp(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
