import { DiamondSep } from "./bloggerUtils";

export default function BloggerHero() {
  return (
    <section
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <p className="fade-up delay-3 mx-auto text-[1.7rem] leading-[1.5] max-w-[520px] text-[var(--text-muted)]">
          Are you a content creator passionate about fragrance and luxury
          lifestyle? Apply to collaborate with Al Hussein Perfumes and bring
          authentic scent stories to your audience.
        </p>
      </div>
    </section>
  );
