...
// ── Post button ───────────────────────────────────────────────────────────────
function PostButton({ loading }: { loading: boolean }) {
  return (
    <button
      type="submit"
      disabled={loading}
...
export default function NewBlogPost() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.body.trim()) newErrors.body = true;
      ...
      <div className="max-w-[820px] mx-auto">
        ...
        <div className="text-center mb-12 mt-12">
          ...
          <p className="mt-4 text-[1.6rem] leading-[1.5] text-[hsla(0,0%,65%,1)]">
            Share your insights, stories, and expertise with our community.
          </p>
        </div>
        ...
        <div className="relative overflow-hidden px-[45px] py-[50px] max-lg:px-[22px] max-lg:py-[35px] max-sm:px-[16px] max-sm:py-[28px] bg-[hsla(40,12%,5%,1)]">
          ...
          {!submitted ? (
            ...
            <div className="text-center py-10">
              ...
              <p className="text-[1.65rem] mb-8 text-[hsla(0,0%,65%,1)]">
