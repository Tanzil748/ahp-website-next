  ...
  return (
    <div className="mb-5">
      ...
      <select
        ...
        className="w-full h-[56px] max-sm:h-[48px] px-5 text-white outline-none transition-colors duration-500 text-[1.6rem] max-sm:text-[1.4rem] appearance-none cursor-pointer"
        style={{
          backgroundColor: eerieBlack2,
          border: `1px solid ${error ? "hsl(0,70%,60%)" : focused ? gold : whiteAlpha10}`,
          fontFamily: "var(--font-dm-sans)",
          ...
          <>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <InputField
                ...
                name="orderId"
                type="text"
                placeholder="e.g. ORD-123456 (optional)"
                value={form.orderId}
                onChange={handleChange}
              />
