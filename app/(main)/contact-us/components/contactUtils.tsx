...
// ─── Legacy named exports — kept for files not yet refactored ─────────────────
...
// ─── Icons ────────────────────────────────────────────────────────────────────
export const LocationIcon = ({ stroke }: { stroke?: string }) => (
  <MaterialSymbolsLocationOnOutline style={{ color: stroke, fontSize: 22 }} />
);

export const PhoneIcon = ({ stroke }: { stroke?: string }) => (
  <BasilPhoneOutline style={{ color: stroke, fontSize: 22 }} />
);

export const EmailIcon = ({ stroke }: { stroke?: string }) => (
  <MaterialSymbolsMailOutline style={{ color: stroke, fontSize: 22 }} />
);
