...
// ─── ORNAMENTAL SEPARATOR (matches separator.svg after .section-subtitle) ─────
...
// ─── SECTION SUBTITLE matches .section-subtitle + .title-2 ────────────────────
...
// ─── DIAMOND SEPARATOR (the .separator element) ───────────────────────────────
function DiamondSep() {
  return (
    <span
      style={{
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Gallery grid (matches about.css gallery-grid) ── */
        .gallery-grid {
          display: grid;
          height: 520px;
        ...
        /* ── FAQ (matches about.css .question) ── */
        .faq-answer {
          font-size: 2.2rem;
          max-height: 0;
          opacity: 0;
        ...
        /* ── Leadership (matches about.css .leader-row) ── */
        .leader-row {
          display: flex;
          gap: 60px;
          margin-bottom: 80px;
        ...
        /* ── Back to top (matches .back-top-btn) ── */
        .back-top-btn {
        ...
        @media (max-width: 600px) {
          ...
          .subscribe-input { border-radius: 12px 12px 0 0 !important; border-right: 1px solid hsla(38,61%,73%,0.35) !important; border-bottom: none !important; height: 52px; }
      ...
      >
        ...
        >
          ...
          {/* Matches .hero-text in about.css exactly */}
          <div
            style={{
              position: "absolute",
              top: "50%",
        ...
        {/* ══════════════════════════════════════
            OUR STORY — matches .about .section
        ══════════════════════════════════════ */}
        <section
          style={{
            position: "relative",
        ...
        >
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 16px" }}>
            ...
            >
              ...
              the best products at competitive prices. Whether you're looking to
              stock your store with iconic scents or seeking exclusive, high-end
              perfumes, Al Hussein Perfumes is your go-to source for premium
              wholesale fragrance solutions. Join us in sharing the beauty and
              elegance of Arab perfumes with the world.
            </p>
            <div
              style={{
                borderRadius: 12,
        ...
        {/* ══════════════════════════════════════
            IMAGE GALLERY — matches .image-gallery
        ══════════════════════════════════════ */}
        <section
          style={{
            paddingTop: 5,
        ...
        {/* ══════════════════════════════════════
            FAQ — matches .questions-container + .question
        ══════════════════════════════════════ */}
        <section
        ...
        >
          ...
          <div
            style={{ maxWidth: 800, margin: "40px auto 0", padding: "0 16px" }}
          >
            {faqs.map((item, i) => (
              <div
                key={i}
        ...
        {/* ══════════════════════════════════════
            SUBSCRIBE — matches .subscribe-section + .subscription-form
        ══════════════════════════════════════ */}
        <section
          style={{
            paddingBlock: 70,
        ...
        >
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 16px" }}>
            ...
            >
              ...
              />
              <button
                className="site-btn site-btn-secondary subscribe-btn"
                style={{
                  height: 52,
                  padding: "0 34px",
              ...
              >
                <span className="t1">Subscribe</span>
              </button>
            </div>
          </div>
        </section>
