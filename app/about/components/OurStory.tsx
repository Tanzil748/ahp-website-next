...
function SectionSubtitle({
  ...
  return (
    <div className={`mb-3 ${center ? "text-center" : "text-left"}`}>
      <span
        className="text-[hsl(38,61%,73%)] font-bold uppercase tracking-[0.4em] text-[2.2rem] leading-[1.2em]"
...
export default function OurStory() {
  return (
    <section className="relative py-10 sm:py-14 md:py-[70px] overflow-hidden bg-[hsla(210,4%,9%,1)]">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-10">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-[70px]">
          ...
          <div className="flex-1 min-w-0 w-full text-center md:text-left">
            ...
            <p
              className="text-[1.45rem] sm:text-[1.6rem] md:text-[1.7rem] text-[hsla(0,0%,65%,1)] mt-5 sm:mt-7 leading-[1.85em]"
            ...
            <p
              className="text-[1.45rem] sm:text-[1.6rem] md:text-[1.7rem] text-[hsla(0,0%,65%,1)] mt-4 sm:mt-5 leading-[1.85em]"
              style={{ fontFamily: "var(--font-dm-sans)" }}
            >
            ...
            {/* Gold rule */}
            <div className="w-[50px] sm:w-[60px] h-[2px] bg-[hsl(38,61%,73%)] opacity-70 my-5 sm:my-7 mx-auto md:mx-0" />

            <p
              className="text-[1.45rem] sm:text-[1.55rem] md:text-[1.6rem] text-[hsl(38,61%,73%)] italic tracking-[0.05em]"
              style={{ fontFamily: "var(--font-forum)" }}
            >
          ...
          <div className="group flex-1 min-w-0 w-full relative overflow-hidden">
            ...
            <div className="absolute inset-[10px] sm:inset-[14px] border border-[hsl(38,61%,73%)] pointer-events-none z-10 opacity-[0.35] transition-opacity duration-500 group-hover:opacity-60" />
            <img
