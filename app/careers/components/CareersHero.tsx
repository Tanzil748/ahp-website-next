export default function CareersHero() {
  ...
  return (
    <section className="relative h-[450px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#1a1a1a] to-[#0c0c0c]">
      ...
      <div className="absolute inset-0 [background:radial-gradient(ellipse_70%_70%_at_50%_50%,#0c0c0c_20%,transparent_80%)]" />
      ...
      <div className="relative z-10 text-center max-w-3xl px-5">
        ...
        <h1 className="fade-up delay-2 text-5xl md:text-7xl font-normal text-white mb-5 font-[var(--font-forum)]">
